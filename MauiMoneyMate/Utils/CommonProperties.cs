...
internal static class CommonProperties
{
    ...
    internal static string InstallationFolderNameOfLatestRelease => string.Format(GeneralInstallationFolderName,
        null == LatestRelease ? VersionInfos.CurrentVersion.Id : LatestRelease.VersionId);
    ...
    internal static string UpdateDirectory => Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\MauiMoneyMate\\Update";
    internal static string GeneralInstallerName => $"{GeneralInstallationFolderName}_Installer.bat";
    ...
    internal static string InstallerNameOfLatestRelease => $"{InstallationFolderNameOfLatestRelease}_Installer.bat";
